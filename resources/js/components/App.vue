        ...
        <div class="flex">
            <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
                <nav class="pt-4">
                    ...
                    <p class="uppercase font-bold text-gray-500 pt-12 text-xs">General</p>
                    ...
                    <p class="uppercase font-bold text-gray-500 pt-12 text-xs">Settings</p>
                    <router-link to="/" class="text-sm flex items-center py-2 hover:text-blue-600">
                        <svg viewBox="0 0 24 24" class="fill-current text-blue-600 w-5 h-5">
                            <path
            ...
            <div class="flex-1 flex flex-col h-screen overflow-y-hidden">
                <div class="flex items-center h-16 p-6 border-b border-gray-400 justify-between">
                    <div>Contacts</div>
                    <div class="rounded-full text-white border border-gray-400 bg-blue-400 w-10 h-10 flex items-center justify-center">VG</div>
                </div>

    ...
    <div>
        ...
        <div v-else>
            <div class="flex justify-between">
                ...
                <div class="relative">
                    <router-link class="px-4 py-2 text-green-500 border border-green-500 text-sm font-bold rounded mr-2"
                                 :to="'/contact/' + contact.contact_id + '/edit'">Edit
                    </router-link>
                    <a class="px-4 py-2 rounded text-red-500 text-sm border border-red-500 rounded text-sm font-bold"
                       href="#" @click="modal=!modal">Delete</a>
                    <div v-if="modal"
                         class="absolute bg-blue-900 text-white rounded-lg z-20 p-8 w-64 right-0 mt-4 mr-6">
                ...
                <div v-if="modal" @click="modal=!modal" class="bg-black opacity-25 absolute inset-0 z-10"></div>
            </div>
